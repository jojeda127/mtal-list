		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Lists",
									"targetURL": "#logaligrouplists-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligrouplists-display": {
								"semanticObject": "logaligrouplists",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.lists",
									"url": sap.ui.require.toUrl("logaligroup/lists")
								}
							}
						}
					}
